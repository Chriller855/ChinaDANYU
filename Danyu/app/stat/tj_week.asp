...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr height="30">
    <td>周访问量统计<br>
        <table width="400">
          <tr>
            <td width="263"><table border="0" cellpadding="0" cellspacing="0" width="175" align=center>
                <tr height="9">
                  <td></td>
                </tr>
                <tr height="101">
...
for i= 0 to 6
%>
                  <td width=15 align=center><a title="<%=voutday(i,1)%>日，星期<%=findweek(clng(voutday(i,2)))%>，访问<%=voutday(i,0)%>次，<%
	'计算访问量的百分数，精确到小数后1位，小于零的在前面加字母0
	lsbf=int(voutday(i,0)*1000/sumday+0.5)/10
	if lsbf<1 then lsbf="0" & lsbf
	Response.Write lsbf
...
case 1%>
                    ...
                    <%end select%>
                    <%=findweek(voutday(i,2))%></font></font></font></a></td>
                  <%
next
%>
                  <td width=10></td>
            ...
            <td width="264"><table border="0" cellpadding="0" cellspacing="0" width="175" align=center>
                <tr height="9">
                  <td></td>
                </tr>
                <tr height="101">
...
%>
                  <td align=right valign=top><p style="line-height: 100%; margin-right: 2; margin-top: 0; margin-bottom: 13"> <font face="Arial"><%=int(maxallweek*10+0.5)/10%></font>
                      <p style="line-height: 100%; margin-right: 2; margin-top: 0; margin-bottom: 13"> <font face="Arial"><%=int(3*maxallweek*10/4+0.5)/10%></font>
                      <p style="line-height: 100%; margin-right: 2; margin-top: 0; margin-bottom: 13"> <font face="Arial"><%=int(maxallweek*10/2+0.5)/10%></font>
                      <p style="line-height: 100%; margin-right: 2; margin-top: 0; margin-bottom: 0"> <font face="Arial"><%=int(maxallweek*10/4+0.5)/10%><br>
                    </font></td>
                  <td width=10><img src="images/tu_back_left.gif"></td>
                  <%
for i= 0 to 6
