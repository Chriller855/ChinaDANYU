...
if trim(request("id"))<>"1" then
	conn.execute("delete from userTypeInfo where typeid="&request("id"))
	conn.close
	set conn=nothing
else
...
<meta http-equiv="refresh" content="1;url=userTypeModifyList.asp">
...
<a href="userTypeModifyList.asp">返回</a> </p>
</body>
</html>
