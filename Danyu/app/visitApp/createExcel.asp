...
sql = "select comeDate,memberName,telphone,mobilePhone,email,address,postCode,comment,dateAndTime from visitApp order by dateAndTime desc"
rs.Open sql,conn
